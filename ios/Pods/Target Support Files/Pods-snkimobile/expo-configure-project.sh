...
with_node \
  ...
  --target "/Users/dwiki/Development/snki-mobile/ios/Pods/Target Support Files/Pods-snkimobile/ExpoModulesProvider.swift" \
  --entitlement "/Users/dwiki/Development/snki-mobile/ios/snkimobile/snkimobile.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linking" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-system-ui" "expo-web-browser"
